CREATE OR REPLACE PROCEDURE DBAX.DELIVERY (
d_w_id			INTEGER,
...
CREATE OR REPLACE PROCEDURE DBAX.DELIVERY_BUP (
d_w_id			INTEGER,
d_o_carrier_id		INTEGER,
timestamp		IN DATE )
IS
...
CREATE OR REPLACE PROCEDURE DBAX.NEWORD (
no_w_id		INTEGER,
no_max_w_id		INTEGER,
no_d_id		INTEGER,
no_c_id		INTEGER,
...
CREATE OR REPLACE PROCEDURE DBAX.OSTAT (
os_w_id			INTEGER,
os_d_id			INTEGER,
...
CREATE OR REPLACE PROCEDURE DBAX.PAYMENT (
p_w_id			INTEGER,
p_d_id			INTEGER,
p_c_w_id		INTEGER,
p_c_d_id		INTEGER,
...
CREATE OR REPLACE PROCEDURE DBAX.SLEV (
st_w_id			INTEGER,
st_d_id			INTEGER,
threshold		INTEGER )
IS 
...
CREATE OR REPLACE PROCEDURE DBAX.SLEV_BUP (
st_w_id			INTEGER,
st_d_id			INTEGER,
threshold		INTEGER )
IS 
